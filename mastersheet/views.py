...
def getRhsData(record):
    ...
    'HH_can_connect_to_Drainage' : 'HH can connect to Drainage line',  'floor_type' : 'Floor Type'}
    # if occupied house then if block called otherwise else block called.
...
def AnalyseGisTabData(slum_id):
    try:
        ...
        columns_lst = ['city_name', 'slum', 'household_number', 'Last Modified At', 'occupancy_status', 'typeUnoccupiedHouse', 'pluscodes', 'pluscodepart', 
                        ...
                        'Have you upgraded your toilet/bathroom/house while constructing individual toilet?', 'Cost of upgradation', 'activity_count', 'HH can connect to Drainage line', 'Floor Type']
        formdict = list(map(getRhsData, householdData))
