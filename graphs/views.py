...
def score_cards(ele):
    ...
    aggrgated_data = ele.aggregate(Sum('occupied_household_count'), Sum('kutcha_household_cnt'), 
        Sum('puccha_household_cnt'), Sum('semi_puccha_household_cnt') ,Sum('household_count'),
