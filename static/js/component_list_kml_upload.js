$(document).ready(function () {
        ...
        components.forEach(function (comp) {
            $("#componentList").append(`
                <div class="list-group-item component-item" 
                    ...
                    <div>${comp.name}</div>
                    <button class="btn btn-danger btn-xs delete-component">Delete</button>
                </div>
            `);
        });
    }
    ...
    // -----------------------------
    // -----------------------------
    (document).off("click", ".delete-component").on("click", ".delete-component", function () {
       const $btn = $(this);
    ...
    // Refresh button
    // -----------------------------
    $(document).on("click", "#refreshComponentList", function () {
        updateComponentListTitle();
        loadComponentList();
    });
